...
\hrule height2pt
\vspace{5mm}
Matemaattisten tieteiden kandiohjelma \\[2mm]
...
\begin{theorem}
Greatest common divisor \cite{LeVeque}
...
Function $f\colon \N \rightarrow \mathbb{R}$ is called number theoretic function. It is multiplicative if $f(ab) = f(a)f(b)$ when $gcd(a, b)=1$.
...
\begin{theorem}
Mertens' theorem \cite{HardyWright}
...
\begin{definition}
The sigma function \cite{HardyWright}
...
\begin{definition}
Riemann zeta function \cite{HardyWright}
...
Let us amuse ourselves with a quick example \cite{Pomerance}.
...
\begin{theorem}
Upper limit of the totient function \cite{HardyWright}
...
\begin{theorem}
Lower limit of the totient function \cite{HardyWright}
