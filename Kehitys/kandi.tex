...
\begin{proof}
\textcolor{blue}{LÄHDE} W. J. LeVeque: Fundamentals of Number Theory, chapter 2.1, theorem 2.1
\end{proof}
...
\begin{lemma}{\emph{Totient function and primes}}
\label{thm:phiprime}
\begin{equation*}
...
Building up to the order of the totient function, we must introduce few functions and theorems that are used in the proof of the lower limit. Since all of the results of this chapter serve mostly as tools, proof for may of the is left untouched.

\begin{theorem}{\emph{Merten's (third) theorem}}
\label{thm:mertens}

\textcolor{blue}{Hardy-Wright: chapter 22.8, theorem 429, p. 466}
\textcolor{red}{Oisko parempi lähde, jossa simppelimpi todistus}
...
\begin{definition}{\emph{Euler-Mascheroni constant}}

\textcolor{blue}{Wolfram MathWorld: Euler-Mascheroni constant}
\textcolor{red}{Onkohan tarpeeks legit lähde}

The Euler-Mascheroni constant $\gamma$ equals the limit of the difference of the harmonic series and natural logarithm. It equals approximately $\gamma\approx 0.57722$. More detailed consideration is outside of the scope of this thesis.

\end{definition}

\begin{definition}{\emph{The sigma-function}}

\textcolor{blue}{Hardy-Wright: chapter 16.7, p. 310}
...
\begin{proof}
\textcolor{blue}{LÄHDE} Theorem 275 in \textit{Hardy \& Wright: Introduction to the Theory of Numbers}.
\end{proof}
\end{lemma}
...
\begin{proof}
\textcolor{blue}{LÄHDE} Theorem 329 in \textit{Hardy \& Wright: Introduction to the Theory of Numbers}.
\end{proof}
\end{theorem}
...
\textcolor{blue}{Hardy-Wright: chapter 22.1, p. 451}
...
\begin{proof}
\textcolor{blue}{LÄHDE} Theorem 414 in \textit{Hardy \& Wright: Introduction to the Theory of Numbers}.
\end{proof}
\end{lemma}

\begin{definition}{\emph{Riemann zeta-function}}

\textcolor{blue}{Hardy-Wright: chapter 17.2, p. 320}
...
\end{equation*}
\begin{proof}
\textcolor{blue}{LÄHDE} Theorem 280 in \textit{Hardy \& Wright: Introduction to the Theory of Numbers}.
\end{proof}
\end{lemma}
...
\textcolor{blue}{Hardy-Wright: chapter 18.4, theorem 326, p. 352}
...
\textcolor{blue}{Hardy-Wright: chapter 18.4, theorem 328, p. 352}
